...
# Default doxygen configuration options
EOS
      doxyfile_contents << Doxyparser::Util.read_file(doxyfile || home_dir+'/resources/Doxyfile')
      doxyfile_path = xml_dir+'/Doxyfile'
      FileUtils.mkdir_p(xml_dir)
      Doxyparser::Util.write_file(doxyfile_path, doxyfile_contents)
      Dir.chdir(xml_dir)
      command = %Q{doxygen < Doxyfile}
